            ...
            <Card className = {styles.Card}>
                <div id = 'space 1'>
                    ...
                    <div id = 'text'  className = {styles.smalltext0}>
                        <p>InPoker is a fresh new approach to online poker that engages social media influencers and offers the first e-sports platform with an integrated DeFi protocol that allows players to participate in poker tournaments by supplying crypto assets and unique NFT membership that provides free entries and exclusive benefits.</p>
                    </div>
