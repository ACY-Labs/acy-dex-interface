...
const Pool = (props)=> {
    ...
    const spans = document.querySelectorAll('.bigTitle span');
              ...
              <div id='space 1'>
                <div className={styles.projectBoxHeader}>
                  ...
                  <div className={styles.moreWrapper}>
                    <button className={styles.projectBtnMore} type="button">
                ...
                <div className={styles.CardHead}>
                  ...
                  <div className={styles.labelInfo}>
                    <h2 className={styles.Label0}> InPoker </h2>
                    <p className={styles.Label1}> $INP </p>
                  </div>
                </div>
                <div id='text' className={styles.smalltext0}>
                  <p>InPoker is a fresh new approach to online poker that engages social media influencers and offers the first e-sports platform with an integrated DeFi protocol.</p>
                </div>
                <ul id='connectbar' className={styles.ConnectBar}>
                  <li>
                    <a href="https://t.me/inpokergroup" target="_blank" className={styles.iconbar} rel="noreferrer"><svg stroke="currentColor" fill="currentColor" stroke-width="0" viewBox="0 0 448 512" height="1em" width="1em" xmlns="http://www.w3.org/2000/svg"><path d="M446.7 98.6l-67.6 318.8c-5.1 22.5-18.4 28.1-37.3 17.5l-103-75.9-49.7 47.8c-5.5 5.5-10.1 10.1-20.7 10.1l7.4-104.9 190.9-172.5c8.3-7.4-1.8-11.5-12.9-4.1L117.8 284 16.2 252.2c-22.1-6.9-22.5-22.1 4.6-32.7L418.2 66.4c18.4-6.9 34.5 4.1 28.5 32.2z"></path></svg></a>
                  </li>
                  <li>
          ...
          <div className={styles.projectContainer}>
            <div className={styles.projectBox1}>
              ...
              <div style={{width: '100%', height: '100%', padding: '2rem 0', justifyContent: 'center', display: 'flex', flexDirection: 'row', alignItems: 'center', paddingTop: '0.5rem'}}>
                ...
                <div style={{display: 'flex', justifyContent: 'center', flexDirection: 'column', paddingLeft: '0.5rem'}}>
                  <p style={{fontWeight: '600', fontSize: '1.25em', color: '#000'}}> InPoker </p>
                  <p style={{display: 'inline-flex', justifyContent: 'center', lineHeight: '1', color: '#000'}}> $INP </p>
                </div>
              </div>
            </div>
            ...
            <div className={styles.projectBox3}>
              <div className={styles.twoInfos}>
                <button className={styles.listprojectBtnMore} type="button">
