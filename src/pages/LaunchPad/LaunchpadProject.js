        ...
        return (
            <div className="flexContainer">
                ...
                <div className="tokenInfo">
                    <span className="tokenTitle">{receivedData.projectName}</span>
        ...
        return (
            <div className="gridContainer">
                <div className="leftGrid">
                    <TokenProcedure />
                    <KeyInformation projectToken={receivedData.projectToken} totalSale={props.totalSale} tokenPrice={receivedData.tokenPrice} />
                </div>
