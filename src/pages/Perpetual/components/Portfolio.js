...
const Portfolio = props => {
  ...
  const eth = infoTokens[getTokenBySymbol(tokens, "ETH").address];
  ...
  console.log('joy', glpMarketCap, formatAmount(glpMarketCap, GLP_DECIMALS, 0, true))
      ...
      <div className={styles.statsContainer}>
        ...
        <div className={styles.statscontent}>
          ...
          <div className={styles.statsRow}>
            ...
            <div className={styles.value}>{formatAmount(glpSupply, GLP_DECIMALS, 4, true)} ALP (${formatAmount(glpSupplyUsd, GLP_DECIMALS, 0, true)})</div>
          </div>

          <div className={styles.statsRow}>
            <div className={styles.label}>Total Staked</div>
            <div className={styles.value}>${formatAmount(glpMarketCap, GLP_DECIMALS, 0, true)}</div>
          </div>
