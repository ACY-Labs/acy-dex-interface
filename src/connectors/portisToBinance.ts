...
interface PortisConnectorArguments_test {
    dAppId: string
    networks: Network[]
    config?: any
}

export class PortisConnector_test extends AbstractConnector {
    ...
    constructor({ dAppId, networks, config = {} }: PortisConnectorArguments_test) {
