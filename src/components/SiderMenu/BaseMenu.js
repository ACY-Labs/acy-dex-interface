...
const getMenuIcon = (name, isSelected) => {
  ...
  if (name == 'Market') {
    return (
      <svg xmlns="http://www.w3.org/2000/svg" fill={color} style={{ height: '35px' }} viewBox="0 0 50 50">
    ...
    return (
      <svg xmlns="http://www.w3.org/2000/svg" fill={color} style={{ height: '35px', transform: 'rotate(180deg)' }} viewBox="0 0 50 50">
