...
const menuIcon = {
  Market:
    <svg xmlns="http://www.w3.org/2000/svg" fill={currentSelected == 'Market' ? '#eb5c20' : '#b5b6b6'} style={{ height: '35px' }} viewBox="0 0 50 50">
  ...
  Exchange:
    <svg xmlns="http://www.w3.org/2000/svg" fill={currentSelected == 'Exchange' ? '#eb5c20' : '#b5b6b6'} style={{ height: '35px' }} viewBox="0 0 50 50">
  ...
  Future:
    <svg xmlns="http://www.w3.org/2000/svg" fill={currentSelected == 'Future' ? '#eb5c20' : '#b5b6b6'} style={{ height: '35px' }} viewBox="0 0 50 50">
  ...
  Option:
    <svg xmlns="http://www.w3.org/2000/svg" fill={currentSelected == 'Option' ? '#eb5c20' : '#b5b6b6'} style={{ height: '35px' }} viewBox="0 0 50 50">
  ...
  Launchpad:
    <svg xmlns="http://www.w3.org/2000/svg" fill={currentSelected == 'Launchpad' ? '#eb5c20' : '#b5b6b6'} style={{ height: '35px' }} viewBox="0 0 50 50">
  ...
  StableCoin:
    <svg xmlns="http://www.w3.org/2000/svg" fill={currentSelected == 'Stablecoin' ? '#eb5c20' : '#b5b6b6'} style={{ height: '35px' }} viewBox="0 0 50 50">
  ...
  Liquidity:
    <svg xmlns="http://www.w3.org/2000/svg" fill={currentSelected == 'Liquidity' ? '#eb5c20' : '#b5b6b6'} style={{ height: '35px' }} viewBox="0 0 50 50">
  ...
  Farm:
    <svg xmlns="http://www.w3.org/2000/svg" fill={currentSelected == 'Farm' ? '#eb5c20' : '#b5b6b6'} style={{ height: '35px' }} viewBox="0 0 50 50">
  ...
  Statistics:
    <svg xmlns="http://www.w3.org/2000/svg" fill={currentSelected == 'Statistics' ? '#eb5c20' : '#b5b6b6'} style={{ height: '35px' }} viewBox="0 0 50 50">
