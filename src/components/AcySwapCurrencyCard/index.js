  ...
  return (
    <div {...rest} className={styles.acycuarrencycard} tabIndex="-1"  onFocus={onFocus} onBlur={onBlur}>
      ...
      <div className={`${styles.cua_body} ${light&&styles.cua_light}`}>
        ...
        <div className={styles.cua_balance} style={{display: title ? "flex" : "none"}}>
          {title || ''}
        </div>
      </div>
    </div>
