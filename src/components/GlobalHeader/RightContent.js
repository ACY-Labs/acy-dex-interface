...
import { Spin, Tag, Menu, Icon, Avatar, Tooltip, Checkbox } from 'antd';
      ...
      <div className={className}>
        ...
        >
          ...
          <AcyCardList style={{ marginTop: '50px' }}>
            <AcyCardList.Agree>
              <AcyCheckBox>I have read, understand, and agree to the <strong>Terms of Service</strong>.</AcyCheckBox>
            </AcyCardList.Agree>
          </AcyCardList>
        </AcyModal>
      </div>
